...
Resumable. Requires 26_Recover_Lost_Treatments.py to have finished first.
"""
...
def main():
    if not INPUT_CSV.exists():
        raise SystemExit(
            f"Missing {INPUT_CSV} - run 26_Recover_Lost_Treatments.py / "
            f"run_26_recover_lost.slurm first")
