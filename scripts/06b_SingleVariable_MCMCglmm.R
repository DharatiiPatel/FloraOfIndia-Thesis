...
env_file <- file.path(base_dir, "Processed Data/step05_outputs/species_environment_trimmed.csv")
loadings <- read.csv(file.path(base_dir, "Processed Data/step05_outputs/pca_loadings.csv"))
