...
Writes under Processed Data/experiments/expansion/ so the primary n=1174
pipeline is untouched.

  READS  : raw_data/fascicles/F{N}_{slug}.txt  (sidecar from OCR array)
           scripts/fascicle_manifest.csv
  WRITES : Processed Data/experiments/expansion/fascicle_descriptions.csv

Usage:  python scripts/28_Parse_Fascicles.py
"""
...
MANIFEST = BASE / "scripts" / "fascicle_manifest.csv"
