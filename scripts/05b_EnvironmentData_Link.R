...
# =============================================================================
# This script:
#   1. Downloads WorldClim (Bio1-Bio19 + elevation) and SoilGrids data
#   2. Extracts environmental values at each GBIF occurrence point
#   3. Removes duplicate grid cells per species
#   4. Calculates 20% trimmed mean per species per variable
#   5. Runs PCA on all environmental variables (PC1-PC10)
#   6. Outputs species x environment matrix ready for MCMCglmm
# =============================================================================
...
# Bio1-Bio19 at 10 minute resolution (same as original paper)
...
# ── Step 2: Download SoilGrids data ──────────────────────────────────────────
...
# ── Step 5: Remove duplicate grid cells per species ───────────────────────────
...
# ── Step 6: Calculate 20% trimmed mean per species ────────────────────────────
...
# ── Step 8: Create binary color columns for MCMCglmm ─────────────────────────
