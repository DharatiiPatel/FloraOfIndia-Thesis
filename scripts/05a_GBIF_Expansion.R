#!/usr/bin/env Rscript
# GBIF fetch for NEW expansion species only.
# Reuses experiments/gbif_cache_clean (no re-download if cached).
# Writes ONLY under experiments/expansion/ — primary gbif_outputs_clean untouched.
